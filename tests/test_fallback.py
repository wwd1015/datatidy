        ...
        class MockTransformationEngine:
            ...
            def _process_column(self, df, column_name, column_config):
                if column_name == "status" and "validation" in column_config:
                    ...
                    raise ValueError("Required field 'status' has null values at indices: [3]")
...
class TestEnhancedLogger:
    ...
    def test_processing_metrics(self):
        ...
        logger.log_column_error("col3", ValueError("Test error"), ErrorCategory.VALIDATION_ERROR)
    ...
    def test_debugging_suggestions(self):
        ...
        # Log some errors
        logger.log_column_error("col1", ValueError("Required field has null values"), 
                               ErrorCategory.VALIDATION_ERROR)
        logger.log_column_error("col2", ValueError("Transformation failed"), 
...
class TestIntegration:
    ...
    def test_end_to_end_partial_processing(self):
        ...
        assert result.processing_mode == ProcessingMode.PARTIAL
        assert len(result.successful_columns) >= 1  # At least some columns should succeed
